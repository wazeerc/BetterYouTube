...
class BetterYoutube {
    ...
    getPiPButtonSVG() {
        return `<svg width="32" height="25" viewBox="0 0 464 364" fill="none" xmlns="http://www.w3.org/2000/svg" style="display:block;margin:auto;">
            <g>
                <path d="M240.375 327H232H97C61.1015 327 32 297.899 32 262V92C32 56.1015 61.1015 27 97 27H367C402.898 27 432 56.1015 432 92V102V139.5V158.25V167.625" stroke="white" stroke-width="24" stroke-linecap="round" stroke-linejoin="round"/>
                <rect x="282" y="215" width="150" height="112" rx="25" stroke="#FF0033" stroke-width="16" stroke-linejoin="round"/>
